...
nohup python3 -c 'import sys; sys.path.insert(0, "."); from tools.web_gui import APP; APP.run(host="127.0.0.1", port=5001, debug=False)' > temp/web_gui.log 2>&1 & echo $! && sleep 1 && ss -ltnp | grep ':5001' || true && sed -n '1,120p' temp/web_gui.log